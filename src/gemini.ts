const GEMINI_API_KEY = "AQ.Ab8RN6IByt_uW4Ij__HPOBqLMFJ5TWpYh2qzO_28QnypyMyInA"
...
export function buildSystemPrompt(companionName: string): string {
  return `You are ${companionName}, a warm, patient, and empathetic AI companion for elderly people, especially those experiencing dementia or memory challenges. You speak simply, kindly, and with great warmth — like a caring family member.
